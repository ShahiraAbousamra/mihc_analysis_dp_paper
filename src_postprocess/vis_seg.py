...
#############################################################################################################################
######## supervised #########
im_dir = '/gpfs/projects/KurcGroup/sabousamra/mihc_analysis_dp_paper/datasets/test_19patches/images'
conc_dir = '/gpfs/projects/KurcGroup/sabousamra/multiplex1.0/eval/sup_dot_19patches'
out_dir_raw = '/gpfs/projects/KurcGroup/sabousamra/multiplex1.0/eval/sup_dot_regH_e6000_19patches_vis'

argmax_dir = '/gpfs/projects/KurcGroup/sabousamra/multiplex1.0/eval/sup_dot_19patches_seg-a_conc-th_size-th_fill_dil'
out_dir_processed = '/gpfs/projects/KurcGroup/sabousamra/multiplex1.0/eval/sup_dot_19patches_seg-a_conc-th_size-th_fill_dil_vis'
...
for im_filepath in im_files:
    ...
    visualize_binary_mask(im_filepath, argmax_filepath, out_dir_processed)
    visualize_mask_stain_conc_map(conc_filepath, argmax_filepath, im_filepath, out_dir_processed)
